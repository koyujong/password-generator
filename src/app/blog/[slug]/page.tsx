...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    translations.forEach((t) => {
        languages[t.language] = `https://pw.4kdrivewalk.com/blog/${t.slug}`;
    });
    const enPost = translations.find((t) => t.language === "en");
    if (enPost) {
        languages["x-default"] = `https://pw.4kdrivewalk.com/blog/${enPost.slug}`;
    }
    ...
    return {
        ...
        alternates: {
            canonical: `https://pw.4kdrivewalk.com/blog/${post.slug}`,
            languages,
        },
        openGraph: {
            title: post.title,
        ...
        <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
            ...
            <main className="pt-32 pb-20 px-4 max-w-3xl mx-auto">
                ...
                <article className="bg-white rounded-[2.5rem] p-8 sm:p-14 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-100">
                    ...
                    <div
                        className="prose prose-slate prose-indigo max-w-none prose-h2:text-2xl prose-h2:font-black prose-h2:mt-12 prose-h2:mb-6 prose-p:text-slate-600 prose-p:leading-relaxed prose-li:text-slate-600 prose-a:text-indigo-600 prose-a:font-semibold prose-a:underline prose-a:decoration-indigo-300 hover:prose-a:decoration-indigo-600 prose-a:underline-offset-2 prose-a:transition-colors"
                    ...
                    <div className="mt-12 mb-8 bg-gradient-to-br from-indigo-600 to-violet-700 rounded-3xl p-10 text-white shadow-2xl overflow-hidden relative group">
