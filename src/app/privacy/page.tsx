    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
            ...
            <main className="pt-24 pb-20 px-4 max-w-3xl mx-auto">
                <h1 className="text-4xl font-extrabold text-slate-900 mb-2 tracking-tight">{t.privacy.title}</h1>
                <p className="text-sm text-slate-400 mb-10">{t.privacy.lastUpdated}</p>
